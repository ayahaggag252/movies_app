...
import 'package:movies_app/controller/controller.dart';
import 'package:movies_app/api/api_constants.dart';
import 'package:movies_app/widgets/bottom_bar_button.dart';
import 'package:movies_app/widgets/cast_card.dart';
import 'package:movies_app/widgets/circular_indicator.dart';
import 'package:movies_app/widgets/icon_widget.dart';
import 'package:movies_app/widgets/text1.dart';
import 'package:movies_app/widgets/text2.dart';
import 'package:movies_app/widgets/title_text.dart';
import 'package:movies_app/widgets/vertical_movie_card.dart';
                        ...
                        return VerticalMovieCard(
                          imgUrl: ApiConstants.baseImgUrl +
                              movieController.similarMovies[index].posterPath
                                  .toString(),
                          movieTitle: ApiConstants.baseImgUrl +
                              movieController.similarMovies[index].title
                                  .toString(),
                          onTap: () {
                            setState(() {
